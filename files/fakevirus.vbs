...
X=MsgBox("Fuck to your Computer",0+64,"Hacker")
X=MsgBox("Your Computer is very slow for me",0+64,"Hacker")
X=MsgBox("Your Computer is fuck",0+64,"Hacker")
X=MsgBox("I am deleting my virus from your computer ",0+64,"Hacker")
X=MsgBox("Sorry :(",0+64,"Hacker")